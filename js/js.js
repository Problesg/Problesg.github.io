...
function Img(){
    ...
    if(h>=6 && h<=11){
        ...
        document.getElementById('welcome').innerHTML = "Good morning Masta";
    }
    if(h>=12 && h<=16) {
        ...
        document.getElementById('welcome').innerHTML = "Good day Masta!";
    }
    if(h>=17 && h<=19) {
        ...
        // ALSO CHANGE YOUR NAME HERE                  "Good morning Yourname!"
        document.getElementById('welcome').innerHTML = "Good afternoon Masta!";
    }
    if((h>=20 && h<=23) || (h>=0 && h<=5)){
        ...
        // ALSO CHANGE YOUR NAME HERE                  "Good morning Yourname!"
        document.getElementById('welcome').innerHTML = "Good night Masta!";
    }
}
function Datum(){
    var today = new Date();
